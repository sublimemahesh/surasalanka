...
<html>
    <head>
        ...
        <title>Report of Pending Orders</title>
    ...
    <body class="theme-red">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="table-responsive ">
                                    <table class="table table-bordered table-striped table-hover dataTable" id="pending-orders">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Order ID</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $orders = Order::getOrdersByDeliveryStatus(0);
                                            $total = 0;
                                            if (count($orders) > 0) {
        ...
        <script src="js/demo.js"></script>
        <script src="js/report-of-pending-orders.js" type="text/javascript"></script>
