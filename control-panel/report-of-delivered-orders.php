...
<html>
    <head>
        ...
        <title>Report of Delivered Orders</title>
    ...
    <body class="theme-red">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="table-responsive ">
                                    <table class="table table-bordered table-striped table-hover dataTable" id="delivered-orders">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Order ID</th>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $orders = Order::getOrdersByDeliveryStatus(1);
                                            $total = 0;
                                            if (count($orders) > 0) {
        ...
        <script src="js/demo.js"></script>
        <script src="js/report-of-delivered-orders.js" type="text/javascript"></script>
        <script type="text/javascript">
            $(document).ready(function () {
                $('#delivered-orders').DataTable({
                    "order": [[0, "asc"]],
                    responsive: true,
                    iDisplayLength: 100,
