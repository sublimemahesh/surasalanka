...
<html>
    <head>
        ...
        <title>Report of Unpaid Orders</title>
    ...
    <body class="theme-red">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="table-responsive ">
                                    <table class="table table-bordered table-striped table-hover dataTable" id="unpaid-orders">
                                        <thead>
                                            <tr>
                                                <th>ID</th>
                                                <th>Order ID</th>
        ...
        <script src="js/demo.js"></script>
        <script src="js/report-of-unpaid-orders.js" type="text/javascript"></script>
        <script type="text/javascript">
            $(document).ready(function () {
                $('#unpaid-orders').DataTable({
                    "order": [[0, "asc"]],
                    responsive: true,
                    iDisplayLength: 100,
