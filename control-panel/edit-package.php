                            ...
                            <div class="body">
                                <form class="form-horizontal"  method="post" action="post-and-get/package.php" enctype="multipart/form-data"> 
                                            ...
                                            <div class="form-line">
                                                <select class="form-control" type="text" id="category" name="category" autocomplete="off" >
                                                    ...
                                                    foreach ($PRODUCT_CATEGORIES->all() as $key => $product_categories) {
                                                        if ($PACKAGE->category == $product_categories['id']) {
                                                            ?>
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select class="form-control" type="text" id="sub_category" autocomplete="off" name="sub_category">
                                                    ...
                                                    foreach ($SUB_CATEGORY->getProductsByCategory($PACKAGE->category) as $key => $sub_categories) {
                                                        if ($PACKAGE->sub_category == $sub_categories['id']) {
                                                            ?>
                                                            <option value="<?php echo $sub_categories['id']; ?>" selected=""><?php echo $sub_categories['name']; ?></option>

                                                            <?php
                                                        } else {
                                                            ?> 
                                                            <option value="<?php echo $sub_categories['id']; ?>"  ><?php echo $sub_categories['name']; ?></option>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="name" class="form-control"  autocomplete="off" name="name" required="true" value="<?php echo $PACKAGE->name ?>">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="number" id="price" class="form-control"  autocomplete="off" name="price" required="true" min="0" value="<?php echo $PACKAGE->price ?>" >
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="number" id="discount" class="form-control"  autocomplete="off" name="discount" required="true" min="0"  value="<?php echo $PACKAGE->discount ?>">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="product-list" class="form-control"  autocomplete="off" name="product_list"  value="<?php echo $PACKAGE->product_list ?>">
