                ...
                <div class="burger-shop-slider owl-carousel owl-theme">
                    ...
                    foreach ($PRODUCT->all() as $product) {
                        ...
                        <div class="burger-shop-item product-box">
                            <div class="image">
                                <a href="view-product.php?id=<?php echo $product['id']; ?>"><img src="upload/product-categories/sub-category/product/photos/<?php echo $product['image_name'] ?> " alt="image"></a>
                                <div class="burger-btn">
                                    <?php
                                    if ($product['in_stock'] == 1) {
                                        ?>
                                        <a href="#" class="default-btn addcart-link view-pop-up4" data-toggle="modal" data-target="#modalLoginForm4_<?php echo $product['id']; ?>" id="" pro-id="<?php echo $product['id']; ?>">
                                            Order Online
                                            <i class="flaticon-play-button"></i>
                                            <span></span>
                                        </a>
